...
SELECT
	...
	name,
	surname,
	CONCAT(surname, " ", SUBSTRING(name, 1, 1), ". ") AS person,
	hometown,
	gender
FROM
	users
...
GROUP BY
	hometown
HAVING
	number_of_users BETWEEN 5 and 10
ORDER BY
	number_of_users;
...
SET
	status = 'declined'
WHERE (initiator_user_id = 7)
	and(target_user_id != 15);

DELETE FROM users
WHERE (hometown = 'Санкт-Петербург')
